...
> [Обзор клиентских API-интерфейсов](/python/api/overview/azure/batch/clientlibrary)
...
> [!div class="nextstepaction"]
> [Обзор API-интерфейсов управления](/python/api/overview/azure/batch/managementlibrary)